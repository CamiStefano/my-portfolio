      ...
      <Card className="card">
        ...
        <div className="summary">
          ...
          <div className="summary__cards">
            ...
            <SummaryCards className="summary__memory__cards">
              <div>
                <span className="summary__memory__img">
                  <svg
                ...
                <span className="summary__memory__p">Memory</span>
              </div>
              <div>
                <span className="summary__number">92 </span>
                <span className="summary__number__total">/ 100</span>
              </div>
            </SummaryCards>

            <SummaryCards className="summary__verbal__cards">
              <div>
                <span className="summary__verbal__img">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
                ...
                <span className="summary__verbal__p">Verbal</span>
              </div>
              <div>
            ...
            <SummaryCards className="summary__visual__cards">
              <div>
                <span className="summary__visual__img">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
